 ...
 * // I modded the library to fit in stm32f103. @SeeleVolleri
 * 
...
const uint8_t MFRC522_firmware_referenceV0_0[] __attribute__((section(".rodata"))) = {
...
const uint8_t MFRC522_firmware_referenceV1_0[] __attribute__((section(".rodata"))) = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
const uint8_t MFRC522_firmware_referenceV2_0[] __attribute__((section(".rodata"))) = {
...
const uint8_t FM17522_firmware_reference[] __attribute__((section(".rodata"))) = {
